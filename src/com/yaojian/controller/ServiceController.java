...
public class ServiceController {
	...
	@ResponseBody
	@RequestMapping(value="/ServiceManager", method={org.springframework.web.bind.annotation.RequestMethod.POST}, consumes={"application/json"})
	public Map<String, Object> service(@RequestBody BaseRequest baseRequst)//HttpServletRequest request, HttpServletResponse response
...
//		JSONObject resultJSONObject = getRequestParamsString(request);
		if (baseRequst == null) {
			...
			String messageType = baseRequst.getMessagetype();
			if (messageType == null) {
				return ResponseUtils.getResponseMessage(MessageUtils.MESSAGEERROR_RSP_STRING, MessageUtils.MESSAGEERROR_MESSAGE_STRING,
						MessageUtils.VERSION_STRING, MessageUtils.MESSAGEERROR_CODE_STRING, null);
			} else {
